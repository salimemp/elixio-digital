...
export default function LoginPage() {
  ...
  return (
    <main className="mx-auto max-w-md px-6 py-12">
      ...
      <p className="mt-2 text-sm text-gray-600">Welcome back. Sign in to your Elixio Digital account.</p>
      ...
      <div className="mt-4 flex flex-col gap-2 text-sm">
        ...
        <Link href="/auth/forgot-password" className="text-gray-600 underline">
